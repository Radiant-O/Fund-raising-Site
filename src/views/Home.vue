<template>
    ...
    <section class="main">
      <div class="proj-header">
        <img src="../assets/images/logo-mastercraft.svg" class="bam-logo">
      ...
      <div class="abt-proj">
        <p class="abt-head">About this project</p>
        <p class="abt-cont">
          The Mastercraft Bamboo Monitor Riser is a sturdy and stylish platform
          that elevates your screen to a more comfortable viewing height.
          Placing your monitor at eye level has the potential to improve your
          posture and make you more comfortable while at work, helping you stay
          focused on the task at hand. <br/><br/> Featuring artisan craftsmanship, the
        ...
        <div class="abt-bam-std">
          <div class="bam-std">
            <p class="edition">Bamboo Stand</p>
        ...
        <div class="abt-bam-std">
          <div class="bam-std">
            <p class="edition">Black Edition Stand</p>
            <p class="pledge">Pledge $75 or more</p>
          </div>
          <p class="abt-bam">
            You get Black Special Edition computer stand and a personal thank you. You'll be added to our Backer member list. Shipping is included.
          </p>
          <div class="bam_foot">
        ...
        <div class="abt-bam-std moga">
          ...
          <p class="abt-bam">
            You get two special Edition Mahogamy stand, a Backer T-Shirt, and a personal thank you. You'll be added to our Backer membr list. Shipping is included.
          </p>
          <div class="bam_foot">
            <p class="avail">0 <span>left</span></p>
            <p class="sos">Out of Stock</p>
          </div>
        </div>
      </div>
    </section>
